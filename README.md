...
We have a [detailed blog post](https://www.fullstackreact.com/articles/how-to-get-create-react-app-to-work-with-your-rails-api/) that explains this app.

### Node+Express version

Check out the [Node+Express version](https://github.com/fullstackreact/food-lookup-demo) if that's your preferred API server platform.
